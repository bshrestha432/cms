...
<body>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li><a href="inbox.php" class="waves-effect"><i data-icon=")"
                                class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Messages</span></a>
                    </li>

                    <li><a href="subscribers.php" class="waves-effect"><i data-icon="n"
                                class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Subscribers</span></a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            ?>  
            <h4>Recent Blog Posts (<b
                    style="color: orange;"><?php echo count($query);?></b>)
            </h4>
                            <table id="postsTable" class="table table-hover">
                                ...
                                <tbody>
                                    <?php 
                                        if (count($query) == 0) {
                                        echo "<tr><td><i style='color:brown;'>No Posts Yet :( Upload Company's first blog post today! </i></td></tr>";}
                                    ?>
                                    </tr>
                                    <?php
                                        ...
                                        echo 
                                        '<tr>
                                            <td class="hidden-xs"><a href="post-details.php?id='.$row["id"].'" />'.$row["title"].'</a></td>
                                            <td class="max-texts"><a href="post-details.php?id='.$row["id"].'" />'.$row["content"].'</a></td>
                        ...
                        <div class="row">
                            <div class="col-xs-7 m-t-20"> Showing 1 - <?php echo count($query);?> </div>
    ...
    <script>
        $(document).ready(function() {
            $('#postsTable').DataTable({
                ...
                "lengthChange": false,     // Disable length change (set number of records per page)
