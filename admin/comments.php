                        ...
                        <div class="white-box">
                            ...
                            <div class="row">
                                ...
                                ?>  
                                                        ...
                                                        <h4>Recent Posts Comments (<b style="color: orange;"><?php echo count($comments); ?></b>)</h4>
                                                        <?php 
                                                             if (count($comments)==0) {
    ...
    while ($row2 = $stmt2->fetch(PDO::FETCH_ASSOC)) {
        ...
        '<div class="comment-body">
            <div class="mail-contnet">
                ...
                <h5>Blog Title : ' . htmlspecialchars($row2["title"]) . '</h5>
                <span class="mail-desc">
                ' . htmlspecialchars($row["comment"]) . '
                </span><a href="javascript:void(0)" class="action" data-toggle="modal" data-target="#responsive-modal' . $row["id"] . '"><i class="ti-close text-danger"></i></a> <span class="time pull-right">' . $row["date"] . '</span>
            </div>
        </div>
...
?>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-7 m-t-20"> Showing 1 - <?php echo count($comments);?> </div>
