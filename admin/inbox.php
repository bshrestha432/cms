                                ...
                                ?>  
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <h4>Recent Messages(<b style="color: orange;"><?php echo count($query); ?></b>)</h4>
                                                        <?php 
                                                             if (count($query)==0) {
                                            ...
                                            <?php
                                                foreach($query as $row ){
                                                    echo '
                                                        <tr>
                                                        <td class="hidden-xs"><a href="inbox-detail.php?id=' . htmlspecialchars($row["id"]) . '">' . htmlspecialchars($row["names"]) . '</a></td>
                                                        <td class="max-texts"><a href="inbox-detail.php?id=' . htmlspecialchars($row["id"]) . '">' . htmlspecialchars($row["message"]) . '</a></td>
                                                        <td class="text-right">' . htmlspecialchars($row["date"]) . '</td>
                                                        </tr>';
                                                }
                                                ?>
