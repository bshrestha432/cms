        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Change Your Profile Picture</h3>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <?php 
                                         ...
                                         $path = $result['image_path'] ?? '../plugins/images/user.jpg';
                                    ?>
                                    <form action="functions/profile_picture.php" method="post"  enctype="multipart/form-data">
                                        <input type="hidden" name="email" value="<?php echo $_SESSION['email']; ?>" />
                                        <!-- EMAIL HIDDEN -->
                                        
                                        <div class="form-group">
                                            <label for="exampleInputpwd1">Your Profile Picture</label>
                                            <div class="input-group">
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image: url(<?php echo $path;?>);">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
